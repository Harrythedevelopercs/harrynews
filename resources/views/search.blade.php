                ...
                <div class="col-4">
                    ...
                    <div class="card mb-5" >
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">published At : {{ $articals['publishedAt'] }}</li>
                            <li class="list-group-item">Source : {{ $articals['source']['name'] }}</li>
                          </ul>
                        <div class="card-body">
                          <a href="{{ $articals['title'] }}" class="btn btn-success  btn-sm"  data-bs-toggle="modal" data-bs-target="#staticBackdrop{{  $i += 1 }}">Read News</a>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <img src="{{ ($articals['urlToImage'] ?: 'https://upload.wikimedia.org/wikipedia/commons/0/0a/No-image-available.png' ) }}" class="card-img-top" alt="News Image" style="width: 500px;height:500px" >
          <div class="wrap">{{ $articals['description'] }}</div>
        </div>
